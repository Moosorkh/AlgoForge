-- Add React.js to algorithms table (it will serve as our content table)
...
-- Add lessons for React.js Fundamentals (ID will be 9)
...
-- Add lessons for React Hooks (ID will be 10)
INSERT INTO lessons (algorithm_id, title, content, lesson_type, order_index)
VALUES 
...
-- Add lessons for React Router (ID will be 11)
INSERT INTO lessons (algorithm_id, title, content, lesson_type, order_index)
VALUES 
